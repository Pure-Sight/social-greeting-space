        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Warunki świadczenia usług OptyClear
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Niniejszy Regulamin określa warunki świadczenia usług przez OptyClear sp. z o.o. 
                z siedzibą w Warszawie, ul. Przykładowa 123, 00-001 Warszawa.
              </p>
              <p className="text-gray-600">
                Regulamin obowiązuje wszystkich Klientów korzystających z usług OptyClear.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                <li><strong>OptyClear</strong> - OptyClear sp. z o.o.</li>
                <li><strong>Klient</strong> - osoba fizyczna lub prawna korzystająca z usług</li>
                <li><strong>Produkt</strong> - stacje czyszczące do okularów oferowane przez OptyClear</li>
                <li><strong>Usługa</strong> - wszelkie usługi świadczone przez OptyClear</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Oferta OptyClear skierowana jest przede wszystkim do klientów biznesowych: 
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p><strong>3.3.</strong> Zamówienie uznaje się za złożone po otrzymaniu potwierdzenia od OptyClear.</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p><strong>5.1.</strong> Na wszystkie produkty OptyClear udziela 24-miesięcznej gwarancji.</p>
                <p><strong>5.2.</strong> Gwarancja obejmuje wady materiałowe i produkcyjne.</p>
                <p><strong>5.3.</strong> Reklamacje należy zgłaszać na adres: reklamacje@optyclear.pl</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                OptyClear zapewnia pełne wsparcie techniczne dla wszystkich produktów:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p><strong>7.1.</strong> OptyClear zastrzega sobie prawo do zmiany Regulaminu.</p>
                <p><strong>7.2.</strong> Zmiany wchodzą w życie po 14 dniach od publikacji.</p>
                <p><strong>7.3.</strong> W sprawach spornych właściwy jest sąd dla siedziby OptyClear.</p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Email: <strong>prawne@optyclear.pl</strong><br />
